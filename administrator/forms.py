...
class ReservationAdminForm(StyledModelForm):
    rooms = forms.ModelMultipleChoiceField(
        ...
        help_text=(
            'Pilih satu atau beberapa kamar '
            'dalam reservasi yang sama.'
        ),
    )
    ...
    def clean(self):
        ...
        if rooms and guests:
            ...
            if guests > capacity:
                self.add_error(
                    'guests',
                    'Kapasitas seluruh kamar maksimal '
                    f'{capacity} tamu.',
                )
...
class UserAccountForm(forms.Form):
    ...
    def clean_nik(self):
        ...
        query = CustomerProfile.objects.filter(
            nik=nik
        )
    ...
    def save(self):
        ...
        if self.role == 'Customer':
            ...
            profile.phone = self.cleaned_data[
                'phone'
            ]

            profile.nik = self.cleaned_data[
                'nik'
            ]
